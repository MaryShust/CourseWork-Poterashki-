...
Мы хотим связать разные районы в единую сеть, где точно можно найти свою вещь. Наш сервис предназначен для помощи людям в поиске потерянных вещей. 
...
| Основной поток: | 1. Пользователь выбирает свой город<br>2. Пользователь указывает свое имя/никнейм<br>3. Пользователь вводит номер телефона |
...
| Главный актер: | Пользователь |
| Предусловия: | Пользователь авторизовался и находится на главной странице |
| Основной поток: | 1. Пользователь настраивает фильтры<br>&nbsp;&nbsp;1.1. выбирает город<br>&nbsp;&nbsp;1.2. выбирает название вещи<br>&nbsp;&nbsp;1.3. указывает дату потери<br>2. Пользователь просматривает каталог с находками |
| Альтернативный поток: | - |
...
| Основной поток: | 1. Пользователь нажимает на кнопку "моя потеряшка"<br>2. Заполняет форму<br>&nbsp;&nbsp;2.1. улица, где была потеряна вещь (не обязательное поле)<br>&nbsp;&nbsp;2.2. место, где была потеряна вещь (не обязательное поле)<br>&nbsp;&nbsp;2.3. особенности вещи (дефекты)<br>3. Пользователю сообщается о том, что заявление было отправлено на обработку<br>4. Сначала проверяется совпадает ли улица, если она есть, если совпадения нет, то пользователю приходит уведомление об отказе. Если совпадения есть или улица не была указана, то приходит уведомление нашедшему вещь на рассмотрение. |
| Альтернативный поток: | - |
